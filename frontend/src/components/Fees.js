...
const Fees = () => {
  ...
  const downloadReceipt = async (receiptNo) => {
    try {
      if (!receiptNo || receiptNo === "PENDING" || receiptNo === "OVERDUE") {
        toast.error("⚠️ Invalid receipt number for download");
        return;
      }

      console.log("⬇️ Downloading receipt:", receiptNo);

      const token = localStorage.getItem("token");
      if (!token) {
        toast.error("❌ Authentication Required", {
          description: "Please login to download receipts.",
        });
        return;
      }

      const response = await axios.get(
        `${API}/fees/receipt/${encodeURIComponent(receiptNo)}?format=pdf`,
        {
          responseType: "blob",
          headers: { Authorization: `Bearer ${token}` },
        },
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-gray-400 mt-1">
            Build: v3.0-final-{new Date().toISOString().split("T")[0]}
          </p>
        </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h2 className="text-xl font-bold text-blue-700">
                  Fee Structure Management & Configuration
                </h2>
                        ...
                        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            ...
                            <p className="text-sm text-gray-600">
                              {getClassName(selectedStudent.class_id)}, Section{" "}
                      ...
                      <CardContent>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                          <div className="text-center p-4 bg-blue-50 rounded-lg">
                            <p className="text-2xl font-bold text-blue-600">
                              ₹
                              {(studentFeesSummary.totalFees / 1000).toFixed(0)}
                              K
                            </p>
                          ...
                          <div className="text-center p-4 bg-green-50 rounded-lg">
                            <p className="text-2xl font-bold text-green-600">
                              ₹
                              {(studentFeesSummary.paidAmount / 1000).toFixed(
                                0,
                              )}
                              K
                            </p>
                          ...
                          <div className="text-center p-4 bg-yellow-50 rounded-lg">
                            <p className="text-2xl font-bold text-yellow-600">
                              ₹
                              {(studentFeesSummary.pendingFees / 1000).toFixed(
                                0,
                              )}
                              K
                            </p>
                          ...
                          <div className="text-center p-4 bg-red-50 rounded-lg">
                            <p className="text-2xl font-bold text-red-600">
                              ₹
                              {(studentFeesSummary.overdueFees / 1000).toFixed(
                                0,
                              )}
                              K
                            </p>
                                  ...
                                  <TableCell>
                                    <div className="flex items-center space-x-2">
                                      ...
                                      payment.receiptNo ? (
                                        <button
                                          onClick={() =>
                                            downloadReceipt(payment.receiptNo)
                                          } // ✅ CORRECT
                                          className="inline-flex items-center justify-center rounded-md border border-gray-200 px-2 py-1 text-xs text-gray-600 hover:bg-gray-50"
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-red-600">
                  Track and collect pending fees, send reminders, manage overdue
                  accounts
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h2 className="text-xl font-bold text-green-700">
                  Dedicated Payment Processing & Collection
                </h2>
                <p className="text-green-600">
                  Process payments, generate receipts, and track daily
                  collections
                </p>
              </div>
            </div>
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-green-600">
                      ...
                      {collectionStats.todaysCollection
                        ? (collectionStats.todaysCollection / 1000).toFixed(0) +
                          "K"
                        : "0"}
                    </p>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-purple-600">
                      ₹
                      {collectionStats.avgPayment
                        ? collectionStats.avgPayment.toLocaleString()
                        : "0"}
                    </p>
              ...
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-orange-600">
                      ₹
                      {collectionStats.cashBalance
                        ? collectionStats.cashBalance.toLocaleString()
                        : "0"}
                    </p>
                        ...
                        {receiptPreview.student && (
                          <div className="space-y-1 text-sm">
                            ...
                            <p>
                              ...
                              {receiptPreview.amount.toLocaleString()}
                            </p>
      ...
      <Dialog open={showPaymentModal} onOpenChange={setShowPaymentModal}>
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          ...
          <PaymentForm
            ...
            // ✅ NEW: pass currently selected student
          ...
          {configToDelete && (
            <div className="bg-gray-50 p-4 rounded-lg">
              <div className="text-sm space-y-1">
                ...
                <p>
                  <strong>Amount:</strong> ₹
                  {configToDelete.amount.toLocaleString()}
                </p>
                <p>
        ...
        <DialogContent className="max-w-5xl">
                      ...
                      <CardContent className="p-4">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                          ...
                          <div>
                            ...
                            <p className="font-bold text-emerald-800">
                              ₹
                              {calculateBulkPaymentSummary().totalAmount.toLocaleString()}
                            </p>
                          </div>
                          <div>
                            ...
                            <p className="font-bold text-emerald-800">
                              ₹
                              {calculateBulkPaymentSummary().lateFees.toLocaleString()}
                            </p>
                          </div>
                          <div>
                            ...
                            <p className="font-bold text-emerald-800">
                              ₹
                              {calculateBulkPaymentSummary().grandTotal.toLocaleString()}
                            </p>
                          </div>
                        </div>
                      </CardContent>
          ...
          <DialogFooter className="gap-2">
            ...
            >
              {loading
                ? "Processing..."
                : `Collect Payment (₹${calculateBulkPaymentSummary().grandTotal.toLocaleString()})`}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>

...
const StaffIDCard = () => {
  ...
  const generateBulkIDCards = async () => {
    if (selectedStaff.size === 0) {
      alert(
        t("idCard.selectStaff") || "Please select at least one staff member",
      );
      return;
    }
          ...
          <div className="flex flex-wrap gap-4 mb-6">
            ...
            <div className="flex-1 min-w-[250px]">
              ...
              <div className="relative">
                ...
                <Input
                  placeholder={
                    t("idCard.searchStaffPlaceholder") ||
                    "নাম, পদবী দিয়ে খুঁজুন..."
                  }
                  value={searchTerm}
              ...
              <table className="w-full border-collapse">
                ...
                <tbody className="divide-y dark:divide-gray-700">
                  {filteredStaff.map((member) => (
                    <tr
                      key={member.id}
                      className={`hover:bg-gray-50 dark:hover:bg-gray-700/50 ${selectedStaff.has(member.id) ? "bg-blue-50 dark:bg-blue-900/20" : ""}`}
                    >
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <Button
                            ...
                            variant="ghost"
                            onClick={() =>
                              generateIDCard(member.id, member.name)
                            }

...
const OnlineAdmission = () => {
  ...
  const [formConfig, setFormConfig] = useState({
    ...
    academicInfo: {
      required: true,
      fields: ["previous_school", "class_applied", "marks"],
    },
    customFields: [],
  });
  ...
  const API_BASE_URL =
    ...
    "https://3516d251-7e36-40e8-b0eb-3a3eaa6959f7-00-3t9xpjugl0f0e.pike.replit.dev:8000/api";
  ...
  const handleExportApplications = async (format = exportFormat) => {
    try {
      ...
      const response = await axios.get(
        `${API_BASE_URL}/admission/export?format=${format}`,
        {
          headers: { Authorization: `Bearer ${token}` },
          responseType: "blob",
        },
      ...
      toast.success(
        `Applications exported as ${format.toUpperCase()} successfully!`,
      );
    } catch (error) {
  ...
  const handleConfigureForm = async () => {
    try {
      ...
      const token = localStorage.getItem("token");
      const response = await axios.get(
        `${API_BASE_URL}/admission/form-config`,
        {
          headers: { Authorization: `Bearer ${token}` },
        },
      );
  ...
  const handleManageDocuments = async () => {
    try {
      ...
      const token = localStorage.getItem("token");
      const response = await axios.get(
        `${API_BASE_URL}/admission/documents-config`,
        {
          headers: { Authorization: `Bearer ${token}` },
        },
      );
  ...
  const handleSetFees = async () => {
    try {
      ...
      const token = localStorage.getItem("token");
      const response = await axios.get(
        `${API_BASE_URL}/admission/fees-config`,
        {
          headers: { Authorization: `Bearer ${token}` },
        },
      );
  ...
  const handleEnablePublicPortal = async () => {
    try {
      ...
      const token = localStorage.getItem("token");
      const response = await axios.get(
        `${API_BASE_URL}/admission/portal-config`,
        {
          headers: { Authorization: `Bearer ${token}` },
        },
      );
  ...
  const handleConfigureNotifications = async () => {
    try {
      ...
      const token = localStorage.getItem("token");
      const response = await axios.get(
        `${API_BASE_URL}/admission/notifications-config`,
        {
          headers: { Authorization: `Bearer ${token}` },
        },
      );
  ...
  const handleSetAcademicYear = async () => {
    try {
      ...
      const token = localStorage.getItem("token");
      const response = await axios.get(
        `${API_BASE_URL}/admission/academic-year-config`,
        {
          headers: { Authorization: `Bearer ${token}` },
        },
      );
  ...
  const handleApproveApplication = async (applicationId) => {
    try {
      ...
      await axios.put(
        `${API_BASE_URL}/admission/update-status`,
        {
      ...
      // optional: still sync from server in background
      // fetchAdmissionData();
    } catch (error) {
      console.error(
  ...
  return (
    <div className="space-y-6 fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Manage digital admission process and applications
          </p>
        </div>
              ...
              {applications.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-4">
                    Online admission applications will appear here
                  </p>
              ...
              <CardContent className="space-y-4">
                <div className="p-4 border border-gray-200 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600 mb-3">
                    Configure admission form fields and requirements
                  </p>
                  <Button
                    variant="outline"
                    size="sm"
                ...
                <div className="p-4 border border-gray-200 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600 mb-3">
                    Set required documents for admission
                  </p>
                  <Button
                    variant="outline"
                    size="sm"
                ...
                <div className="p-4 border border-gray-200 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600 mb-3">
                    Configure admission and monthly fees
                  </p>
                  <Button variant="outline" size="sm" onClick={handleSetFees}>
                    Set Fees
                  </Button>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="p-4 border border-gray-200 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600 mb-3">
                    Manage public admission portal visibility
                  </p>
                  <div className="flex space-x-2">
                    ...
                    <Button
                      size="sm"
                      className="bg-emerald-500 hover:bg-emerald-600"
                      onClick={handleEnablePublicPortal}
                    >
                      Configure
                    </Button>
                  </div>
                ...
                <div className="p-4 border border-gray-200 rounded-lg">
                  ...
                  <p className="text-sm text-gray-600 mb-3">
                    Set admission period and deadlines
                  </p>
                  <Button
                    variant="outline"
                    size="sm"
                ...
                {[
                  ...
                  >
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleClassLimitChange(className, e.target.value)
                      }
                      className="w-20"
                      min={1}
                      max={100}
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Select
                      value={
                        settingsData.smsNotifications ? "enabled" : "disabled"
                      }
                      onValueChange={(value) =>
                        setSettingsData((prev) => ({
                          ...prev,
      ...
      <Dialog
        open={isFormConfigModalOpen}
        onOpenChange={setIsFormConfigModalOpen}
      >
        <DialogContent className="max-w-3xl">
          <DialogHeader>
            <DialogTitle>Configure Admission Form</DialogTitle>
            <DialogDescription>
              Customize form fields and requirements for online admission
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  {["father_name", "mother_name", "guardian_phone"].map(
                    (field) => (
                      <div key={field} className="flex items-center space-x-2">
                        <input
                          type="checkbox"
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  {["previous_school", "class_applied", "marks"].map(
                    (field) => (
                      <div key={field} className="flex items-center space-x-2">
                        <input
                          type="checkbox"
      ...
      >
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Configure required documents for admission
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button
              className="bg-emerald-500 hover:bg-emerald-600"
              onClick={handleSaveDocumentsConfig}
              disabled={loading}
            >
              {loading ? "Saving..." : "Save Configuration"}
            </Button>
      ...
      <Dialog open={isFeesModalOpen} onOpenChange={setIsFeesModalOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Set admission and monthly fees
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                {Object.entries(feesConfig.monthlyFee).map(
                  ([classRange, fee]) => (
                    <div
                      key={classRange}
                      className="flex items-center justify-between"
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setFeesConfig((prev) => ({
                            ...
                            monthlyFee: {
                              ...prev.monthlyFee,
                              [classRange]: parseInt(e.target.value) || 0,
                            },
                          }))
                        }
                        className="w-24"
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setIsFeesModalOpen(false)}>
              Cancel
            </Button>
            <Button
              className="bg-emerald-500 hover:bg-emerald-600"
      ...
      <Dialog open={isPortalModalOpen} onOpenChange={setIsPortalModalOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Configure public admission portal settings
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog
        ...
        onOpenChange={setIsAcademicYearModalOpen}
      >
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>Academic Year Configuration</DialogTitle>
            <DialogDescription>
              Set academic year and admission deadlines
            </DialogDescription>
          </DialogHeader>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setAcademicYearConfig((prev) => ({
                      ...prev,
                      admissionEndDate: e.target.value,
                    }))
                  }
                />
              </div>
          ...
          <DialogFooter>
            ...
            <Button
              className="bg-emerald-500 hover:bg-emerald-600"
              onClick={handleSaveAcademicYearConfig}
              disabled={loading}
            >
              {loading ? "Saving..." : "Save Configuration"}
            </Button>

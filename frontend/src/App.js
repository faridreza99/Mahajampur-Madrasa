...
const Layout = ({ children }) => {
  ...
  if (isLoginPage) {
    // For /login we don't show Sidebar/Header layout
    return children;
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      {/* Main section shifted right by sidebar width on md+ */}
      <div className="md:ml-64 flex flex-col min-h-screen">
        <Header />
        <main className="flex-1 overflow-y-auto bg-gray-50 dark:bg-gray-950 px-4 py-6 md:px-6 md:py-8">
          <div className="min-h-[calc(100vh-100px)] pb-24">{children}</div>
        </main>
      </div>
    </div>
  );

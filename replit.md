...
- **Class Management with Class Subjects**: Enhanced class management module with three tabs - Classes, Sections, and Class Subjects. Features include: (1) Manage classes with class teachers and max students, (2) Manage sections under each class, (3) Add/Edit/Delete subjects for specific classes/standards, (4) Subject properties: name, code, class/standard, description, elective/core type, (5) Filter subjects by class, (6) Dynamic subject dropdowns throughout the app - subjects added here automatically appear in AI Quiz, AI Summary, AI Notes, Timetable, and other modules.

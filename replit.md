...
- **Notification Module**: Comprehensive in-app notification system with role-based access. Features include: (1) Admin/Teacher can view/edit/delete notifications, Students can view only, (2) In-app notification display with read/unread tracking, (3) Class-wise, Section-wise, Subject-wise filtering, (4) Built-in templates: Timetable Upgrade, Exam Date Alert, Progress Report Update, Custom Notification, (5) Notification format with Title + Body, (6) Priority levels (low, normal, high, urgent), (7) Mark as read/Mark all as read functionality.
